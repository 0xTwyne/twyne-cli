...
@click.pass_context
def cli(ctx, rpc, force_json, block, no_cache, verbose):
    ...
    ctx.obj = TwyneContext(rpc_url=rpc_url, force_json=force_json, block=block, no_cache=no_cache, verbose=verbose)
